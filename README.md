...
- `git clone https://github.com/UniversalPropositions/UP_Romanian-SiMoNERo.git`
...
- `python3 up2/merge_ud_up.py --input_ud=<ud_path_to_UD_Romanian-SiMoNERo>/ --input_up=<up_path_to_UP_Romanian-SiMoNERo>/ --output=<path_to_UD+UP_Romanian-SiMoNERo>/`
